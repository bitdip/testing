...
#st.set_option("deprecation.showPyplotGlobalUse", False)  <--------- CEK LAGI ERROR INI PERBAIKI
...
options = st.radio(
    "Data Usage", options=["Upload file"], horizontal=True    #"Data Usage", options=["Upload file", "Use Data in Storage"], horizontal=True
)
